                            ...
                            <Carousel fade>
                                <Carousel.Item style={{ position: 'relative' }}>
                                    ...
                                    <div className="carousel-button-container">
                                        <Button variant="primary" href="/halllist" className="carousel-button">Start Your Booking</Button>
                                    </div>
                                </Carousel.Item>
                                <Carousel.Item style={{ position: 'relative' }}>
...
//                                 />
//                                   <div className="carousel-button-container">
//                                         <Button variant="primary" href="/bookings" className="carousel-button">Start Your Booking</Button>
//                                     </div>
//                             </Carousel.Item>
//                         </Carousel>
//                     </Col>
